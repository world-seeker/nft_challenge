...
const uploadPost = async () => {
    ...
    //create a post andd add on firestore
    //2) get the post id for the  newly create post
    //3)upload the image to firbase storage with the post id
    //4)get a downloa url from fb storage and update the original post with image
...
const addImageToPost = (e: { target: { files: Blob[]; }; }) => {
  ...
  return (
   ...
   sm:min-h-screen pt-4 pz-4 pb-20 text-center sm:block sm:p-0">
     <Transition.Child
     as={Fragment}
            ...
            <div className="mt-5 sm:mt-6">
              ...
              disabled={!selectedFile}
               type="button"
                ...
                rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600
                text-base font-medium text-white hover:bg-red-700 focus:outline-none
                focus:ring-2 focus:ring-red-500 sm-text-sm disabled:bg-gray-300
